...
const styles = StyleSheet.create({
  ...
  previewScrim: { position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(13,15,11,0.45)' },
  ...
  error: { fontFamily: font.medium, fontSize: 13.5, color: '#E5786A', lineHeight: 19 },
  result: { borderRadius: radius.card, padding: 16, gap: 6, borderWidth: 1 },
  resultOk: { backgroundColor: 'rgba(189,242,69,0.10)', borderColor: 'rgba(189,242,69,0.3)' },
  ...
  guaranteeBtn: {
    ...
    justifyContent: 'center',
    gap: 7,
    backgroundColor: 'rgba(189,242,69,0.12)',
    borderRadius: radius.field,
    paddingVertical: 14,
  },
